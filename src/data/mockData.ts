...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    id: 'teacher-gioi',
    name: 'Gioi',
    englishName: 'Teacher Gioi',
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    role: 'teacher',
    email: 'gioivd@gmail.com',
    password: 'starkids2026',
    phone: '0988 776 655',
    status: 'approved',
    registeredAt: '2026-03-01',
    levelTitle: 'Lead ESL Teacher (Trưởng Khối Tiếng Anh)'
  },
  {
    id: 'teacher-1',
...
export const INITIAL_CLASSES: ClassRoom[] = [
  ...
  },
  {
    ...
    grade: 5,
    teacherName: 'Thầy Michael Jenkins',
